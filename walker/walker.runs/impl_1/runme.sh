...
HD_PWD='C:/Users/user/Documents/nguyen vivado/walker/walker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log walker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source walker.tcl -notrace
