...
HD_PWD='C:/Users/user/Documents/nguyen vivado/walker/walker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log walker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source walker.tcl
