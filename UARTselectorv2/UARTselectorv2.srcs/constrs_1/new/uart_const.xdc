...
set_property IOSTANDARD LVCMOS33 [get_ports sel_out]

set_property PACKAGE_PIN L1 [get_ports buffA]
set_property IOSTANDARD LVCMOS33 [get_ports buffA]
set_property PACKAGE_PIN P1 [get_ports buffB]
set_property IOSTANDARD LVCMOS33 [get_ports buffB]
set_property PACKAGE_PIN N3 [get_ports buffC]
set_property IOSTANDARD LVCMOS33 [get_ports buffC]
