...
HD_PWD='C:/Users/user/Documents/nguyen vivado/walkerreq/walkerreq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log walkerreq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source walkerreq.tcl -notrace
