...
HD_PWD='C:/Users/user/Documents/nguyen vivado/walkerreq/walkerreq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log walkerreq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source walkerreq.tcl
